...
\heading{Antoine}{de Roquemaurel}{Développeur}
 {
	\contact{
		...
		\texttt{\hspace{-20px}\Mundus~https://aroquemaurel.github.io}
	}{	
...
\cventry{Avril~--~Juillet~2014\\{\vspace{0.5mm}\small\color{gray} Freelance}\\\small\color{gray} Java, Antlr4}
...
\cvline{\textbf{Associatif}}{Animateur bénévole Scouts et
Guides de France. Enfants de 6 à 11 ans (2009 -- 2012)\newline
		Membre des organisateurs de la nuit de l'info toulousaine (2013, 2014)}
